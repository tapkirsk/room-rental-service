...
<div class="box">
	...
	<form name="login" onsubmit="check(this)" method="post" action="">
		...
		Not Registered yet ? <a href="customer registration/customerregister.php"> Sign Up</a>
		<br><br>
...
if($_SERVER['REQUEST_METHOD']=='POST')
	...
	$password=$_POST['pwd'];
		...
		if(isset($_POST['submit']))
		{
			...
			$query="select * from customer_details where cust_username='$username' and cust_password='$password'";
